...
Jeg er 21 år og har interesse for koding knyttet til å lage egne dataspill, og formålet mitt er både å lære, men også utforske nye løsninger og ideer.
...
I tillegg til dette har jeg plukket opp flere språk på veien, f.eks. HTML, CSS, JavaScript, TypeScript, Python og Ruby.
